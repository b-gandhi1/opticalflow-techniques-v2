...
fig_pitch, (ax1, ax2, ax3) = plt.subplots(3, 1, gridspec_kw={'height_ratios': [4, 1, 1]})
...
ax5.plot(ts, pressure_roll)
# ax5.set_xlabel('Time (s)')
ax5.set_ylabel('Pressure (kPa)')
# pressure plot derivative
pres_roll_grad = np.gradient(pressure_roll)
ax6.plot(ts, pres_roll_grad)
ax6.set_xlabel('Time (s)')
ax6.set_ylabel('dP/dt (kPa/s)')
plt.tight_layout()

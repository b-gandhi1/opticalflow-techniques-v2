...
# from https://github.com/rajatjain3571/Susan-Corner-Detection/blob/master/susanCornerDetection.py 
...
# img = cv.imread("data_collection_with_franka/B07LabTrials/susan_input1.png",0)
...
# img = cv.imread("data_collection_with_franka/B07LabTrials/susan_input2.png",0)
...
# print('normalize shape: ', np.shape(normalize))
# output3 = susan_corner_detection(normalize)
# normalize = cv.convertScaleAbs(normalize)
